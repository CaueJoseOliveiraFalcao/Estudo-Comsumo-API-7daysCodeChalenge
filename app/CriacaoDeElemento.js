...
function RenderizarFilmes(film){
  ...
  Divp.innerHTML = ''
    film.forEach(element => {
      if (element.overview == ''){
        element.overview = 'Sem Descrição'
      }
      Divp.innerHTML += `<div class="div_cards mt-5 d-flex flex-row justify-content-center">
              <div class="card_color card mb-3">
                  ...
                  <div class="card_area_de_if_tituloAvalicao mx-3 ">
                      ...
                      <div class="curtir_fav d-flex flex-row align-items-center">
                          <img class='img_class' src='./img/Star.png'/>
                          <p class='vote_rate'>${element.vote_average}</p>
                      </div>
                  </div>
